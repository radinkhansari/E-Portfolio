...
//make sure you have at least 6 of them
...
export const ProjectsSection = () => {
    ...
    <section id="projects" className = "py-24 px-4 relative">
        <div className = "container mx-auto max-w-5xl">
            ...
            Here are some of my projects. Each project was carefully crafted with attention to detail, performance anduser experience.
            </p>
            <div className = "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project,key) => (
                    ...
                    className = "group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
                        ...
                        <b className = "text-muted-foreground text-sm mb-4">{project.description}</b>
            ...
            <div className = "text-center mt-12">
                ...
                target = "_blank" 
                href="https://github.com/radinkhansari">
